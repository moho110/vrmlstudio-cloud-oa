...
public class XinhuKqdkjlController extends BaseController
{
     ...
     * 查询打卡记录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:list')")
    @GetMapping("/list")
     ...
     * 导出打卡记录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:export')")
     ...
     * 获取打卡记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增打卡记录
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:add')")
     ...
     * 修改打卡记录
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:edit')")
     ...
     * 删除打卡记录
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdkjl:remove')")
