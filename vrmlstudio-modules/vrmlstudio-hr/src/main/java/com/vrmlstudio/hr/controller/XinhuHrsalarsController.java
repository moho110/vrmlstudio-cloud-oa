...
public class XinhuHrsalarsController extends BaseController
{
     ...
     * 查询薪资模版子列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:list')")
    @GetMapping("/list")
     ...
     * 导出薪资模版子列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:export')")
     ...
     * 获取薪资模版子详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增薪资模版子
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:add')")
     ...
     * 修改薪资模版子
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:edit')")
     ...
     * 删除薪资模版子
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalars:remove')")
