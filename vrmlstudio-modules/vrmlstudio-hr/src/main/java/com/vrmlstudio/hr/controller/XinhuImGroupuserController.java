...
public class XinhuImGroupuserController extends BaseController
{
     ...
     * 查询IM会话人员列表
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:list')")
    @GetMapping("/list")
     ...
     * 导出IM会话人员列表
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:export')")
     ...
     * 获取IM会话人员详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM会话人员
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:add')")
     ...
     * 修改IM会话人员
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:edit')")
     ...
     * 删除IM会话人员
     */
    @PreAuthorize("@ss.hasPermi('hr:groupuser:remove')")
