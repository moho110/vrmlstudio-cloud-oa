...
public class XinhuKnowledgeController extends BaseController
{
     ...
     * 查询知识信息列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:list')")
    @GetMapping("/list")
     ...
     * 导出知识信息列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:export')")
     ...
     * 获取知识信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增知识信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:add')")
     ...
     * 修改知识信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:edit')")
     ...
     * 删除知识信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowledge:remove')")
