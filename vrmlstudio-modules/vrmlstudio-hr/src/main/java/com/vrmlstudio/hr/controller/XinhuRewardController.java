...
public class XinhuRewardController extends BaseController
{
     ...
     * 查询奖惩列表
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:list')")
    @GetMapping("/list")
     ...
     * 导出奖惩列表
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:export')")
     ...
     * 获取奖惩详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增奖惩
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:add')")
     ...
     * 修改奖惩
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:edit')")
     ...
     * 删除奖惩
     */
    @PreAuthorize("@ss.hasPermi('hr:reward:remove')")
