...
public class XinhuKqdwController extends BaseController
{
     ...
     * 查询考勤定位规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:list')")
    @GetMapping("/list")
     ...
     * 导出考勤定位规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:export')")
     ...
     * 获取考勤定位规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考勤定位规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:add')")
     ...
     * 修改考勤定位规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:edit')")
     ...
     * 删除考勤定位规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqdw:remove')")
