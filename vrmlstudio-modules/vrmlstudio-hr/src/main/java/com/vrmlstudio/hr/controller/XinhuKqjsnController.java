...
public class XinhuKqjsnController extends BaseController
{
     ...
     * 查询考勤机设备列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:list')")
    @GetMapping("/list")
     ...
     * 导出考勤机设备列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:export')")
     ...
     * 获取考勤机设备详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考勤机设备
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:add')")
     ...
     * 修改考勤机设备
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:edit')")
     ...
     * 删除考勤机设备
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjsn:remove')")
