...
public class XinhuHrsalaryController extends BaseController
{
     ...
     * 查询工资列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:list')")
    @GetMapping("/list")
     ...
     * 导出工资列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:export')")
     ...
     * 获取工资详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增工资
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:add')")
     ...
     * 修改工资
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:edit')")
     ...
     * 删除工资
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalary:remove')")
