...
public class XinhuHrtrsalaryController extends BaseController
{
     ...
     * 查询调薪申请列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:list')")
    @GetMapping("/list")
     ...
     * 导出调薪申请列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:export')")
     ...
     * 获取调薪申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增调薪申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:add')")
     ...
     * 修改调薪申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:edit')")
     ...
     * 删除调薪申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrtrsalary:remove')")
