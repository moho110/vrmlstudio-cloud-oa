...
public class XinhuImMessztController extends BaseController
{
     ...
     * 查询IM聊天消息状态列表
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:list')")
    @GetMapping("/list")
     ...
     * 导出IM聊天消息状态列表
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:export')")
     ...
     * 获取IM聊天消息状态详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM聊天消息状态
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:add')")
     ...
     * 修改IM聊天消息状态
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:edit')")
     ...
     * 删除IM聊天消息状态
     */
    @PreAuthorize("@ss.hasPermi('hr:messzt:remove')")
