...
public class XinhuKnowtraimController extends BaseController
{
     ...
     * 查询培训出题考试列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:list')")
    @GetMapping("/list")
     ...
     * 导出培训出题考试列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:export')")
     ...
     * 获取培训出题考试详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增培训出题考试
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:add')")
     ...
     * 修改培训出题考试
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:edit')")
     ...
     * 删除培训出题考试
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtraim:remove')")
