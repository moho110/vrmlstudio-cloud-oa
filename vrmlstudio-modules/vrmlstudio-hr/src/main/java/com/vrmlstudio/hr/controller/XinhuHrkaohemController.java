...
public class XinhuHrkaohemController extends BaseController
{
     ...
     * 查询考核项目列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:list')")
    @GetMapping("/list")
     ...
     * 导出考核项目列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:export')")
     ...
     * 获取考核项目详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考核项目
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:add')")
     ...
     * 修改考核项目
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:edit')")
     ...
     * 删除考核项目
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohem:remove')")
