...
public class XinhuImMenuController extends BaseController
{
     ...
     * 查询IM下应用菜单列表
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:list')")
    @GetMapping("/list")
     ...
     * 导出IM下应用菜单列表
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:export')")
     ...
     * 获取IM下应用菜单详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM下应用菜单
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:add')")
     ...
     * 修改IM下应用菜单
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:edit')")
     ...
     * 删除IM下应用菜单
     */
    @PreAuthorize("@ss.hasPermi('hr:menu:remove')")
