...
public class XinhuHrpositiveController extends BaseController
{
     ...
     * 查询HR转正列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:list')")
    @GetMapping("/list")
     ...
     * 导出HR转正列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:export')")
     ...
     * 获取HR转正详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增HR转正
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:add')")
     ...
     * 修改HR转正
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:edit')")
     ...
     * 删除HR转正
     */
    @PreAuthorize("@ss.hasPermi('hr:hrpositive:remove')")
