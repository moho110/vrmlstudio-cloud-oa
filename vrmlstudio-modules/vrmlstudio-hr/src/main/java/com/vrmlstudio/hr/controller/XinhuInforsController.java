...
public class XinhuInforsController extends BaseController
{
     ...
     * 查询信息子投票项列表
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:list')")
    @GetMapping("/list")
     ...
     * 导出信息子投票项列表
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:export')")
     ...
     * 获取信息子投票项详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增信息子投票项
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:add')")
     ...
     * 修改信息子投票项
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:edit')")
     ...
     * 删除信息子投票项
     */
    @PreAuthorize("@ss.hasPermi('hr:infors:remove')")
