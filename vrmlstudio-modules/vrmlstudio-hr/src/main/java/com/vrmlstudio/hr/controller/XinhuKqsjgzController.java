...
public class XinhuKqsjgzController extends BaseController
{
     ...
     * 查询考勤时间规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:list')")
    @GetMapping("/list")
     ...
     * 导出考勤时间规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:export')")
     ...
     * 获取考勤时间规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考勤时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:add')")
     ...
     * 修改考勤时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:edit')")
     ...
     * 删除考勤时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqsjgz:remove')")
