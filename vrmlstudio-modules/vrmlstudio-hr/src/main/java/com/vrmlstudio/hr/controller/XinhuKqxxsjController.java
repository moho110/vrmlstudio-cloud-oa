...
public class XinhuKqxxsjController extends BaseController
{
     ...
     * 查询休息时间规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:list')")
    @GetMapping("/list")
     ...
     * 导出休息时间规则列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:export')")
     ...
     * 获取休息时间规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增休息时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:add')")
     ...
     * 修改休息时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:edit')")
     ...
     * 删除休息时间规则
     */
    @PreAuthorize("@ss.hasPermi('hr:kqxxsj:remove')")
