...
public class XinhuVcardController extends BaseController
{
     ...
     * 查询个人通讯录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:list')")
    @GetMapping("/list")
     ...
     * 导出个人通讯录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:export')")
     ...
     * 获取个人通讯录详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增个人通讯录
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:add')")
     ...
     * 修改个人通讯录
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:edit')")
     ...
     * 删除个人通讯录
     */
    @PreAuthorize("@ss.hasPermi('hr:vcard:remove')")
