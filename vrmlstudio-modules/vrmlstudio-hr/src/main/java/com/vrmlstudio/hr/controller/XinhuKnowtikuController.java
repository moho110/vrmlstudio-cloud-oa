...
public class XinhuKnowtikuController extends BaseController
{
     ...
     * 查询知识题库列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:list')")
    @GetMapping("/list")
     ...
     * 导出知识题库列表
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:export')")
     ...
     * 获取知识题库详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增知识题库
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:add')")
     ...
     * 修改知识题库
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:edit')")
     ...
     * 删除知识题库
     */
    @PreAuthorize("@ss.hasPermi('hr:knowtiku:remove')")
