...
public class XinhuKqjcmdController extends BaseController
{
     ...
     * 查询考勤机命令发送列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:list')")
    @GetMapping("/list")
     ...
     * 导出考勤机命令发送列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:export')")
     ...
     * 获取考勤机命令发送详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考勤机命令发送
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:add')")
     ...
     * 修改考勤机命令发送
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:edit')")
     ...
     * 删除考勤机命令发送
     */
    @PreAuthorize("@ss.hasPermi('hr:kqjcmd:remove')")
