...
public class XinhuHrredundController extends BaseController
{
     ...
     * 查询离职申请列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:list')")
    @GetMapping("/list")
     ...
     * 导出离职申请列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:export')")
     ...
     * 获取离职申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增离职申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:add')")
     ...
     * 修改离职申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:edit')")
     ...
     * 删除离职申请
     */
    @PreAuthorize("@ss.hasPermi('hr:hrredund:remove')")
