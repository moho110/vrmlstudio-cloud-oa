...
public class XinhuHrsalarmController extends BaseController
{
     ...
     * 查询薪资模版列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:list')")
    @GetMapping("/list")
     ...
     * 导出薪资模版列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:export')")
     ...
     * 获取薪资模版详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增薪资模版
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:add')")
     ...
     * 修改薪资模版
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:edit')")
     ...
     * 删除薪资模版
     */
    @PreAuthorize("@ss.hasPermi('hr:hrsalarm:remove')")
