...
public class XinhuHrkaohesController extends BaseController
{
     ...
     * 查询考核项目的内容列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:list')")
    @GetMapping("/list")
     ...
     * 导出考核项目的内容列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:export')")
     ...
     * 获取考核项目的内容详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考核项目的内容
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:add')")
     ...
     * 修改考核项目的内容
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:edit')")
     ...
     * 删除考核项目的内容
     */
    @PreAuthorize("@ss.hasPermi('hr:hrkaohes:remove')")
