...
public class XinhuImHistoryController extends BaseController
{
     ...
     * 查询IM会话记录历史列表
     */
    @PreAuthorize("@ss.hasPermi('hr:history:list')")
    @GetMapping("/list")
     ...
     * 导出IM会话记录历史列表
     */
    @PreAuthorize("@ss.hasPermi('hr:history:export')")
     ...
     * 获取IM会话记录历史详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:history:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM会话记录历史
     */
    @PreAuthorize("@ss.hasPermi('hr:history:add')")
     ...
     * 修改IM会话记录历史
     */
    @PreAuthorize("@ss.hasPermi('hr:history:edit')")
     ...
     * 删除IM会话记录历史
     */
    @PreAuthorize("@ss.hasPermi('hr:history:remove')")
