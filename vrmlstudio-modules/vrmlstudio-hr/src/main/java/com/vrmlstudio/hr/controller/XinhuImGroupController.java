...
public class XinhuImGroupController extends BaseController
{
     ...
     * 查询IM会话列表
     */
    @PreAuthorize("@ss.hasPermi('hr:group:list')")
    @GetMapping("/list")
     ...
     * 导出IM会话列表
     */
    @PreAuthorize("@ss.hasPermi('hr:group:export')")
     ...
     * 获取IM会话详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:group:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM会话
     */
    @PreAuthorize("@ss.hasPermi('hr:group:add')")
     ...
     * 修改IM会话
     */
    @PreAuthorize("@ss.hasPermi('hr:group:edit')")
     ...
     * 删除IM会话
     */
    @PreAuthorize("@ss.hasPermi('hr:group:remove')")
