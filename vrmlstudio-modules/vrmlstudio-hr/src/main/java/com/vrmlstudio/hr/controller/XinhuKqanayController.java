...
public class XinhuKqanayController extends BaseController
{
     ...
     * 查询考勤分析列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:list')")
    @GetMapping("/list")
     ...
     * 导出考勤分析列表
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:export')")
     ...
     * 获取考勤分析详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考勤分析
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:add')")
     ...
     * 修改考勤分析
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:edit')")
     ...
     * 删除考勤分析
     */
    @PreAuthorize("@ss.hasPermi('hr:kqanay:remove')")
