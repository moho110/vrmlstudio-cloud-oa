...
public class XinhuHrcheckController extends BaseController
{
     ...
     * 查询考核评分列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:list')")
    @GetMapping("/list")
     ...
     * 导出考核评分列表
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:export')")
     ...
     * 获取考核评分详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考核评分
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:add')")
     ...
     * 修改考核评分
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:edit')")
     ...
     * 删除考核评分
     */
    @PreAuthorize("@ss.hasPermi('hr:hrcheck:remove')")
