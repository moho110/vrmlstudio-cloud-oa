...
public class XinhuImMessController extends BaseController
{
     ...
     * 查询IM聊天记录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:list')")
    @GetMapping("/list")
     ...
     * 导出IM聊天记录列表
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:export')")
     ...
     * 获取IM聊天记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增IM聊天记录
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:add')")
     ...
     * 修改IM聊天记录
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:edit')")
     ...
     * 删除IM聊天记录
     */
    @PreAuthorize("@ss.hasPermi('hr:mess:remove')")
