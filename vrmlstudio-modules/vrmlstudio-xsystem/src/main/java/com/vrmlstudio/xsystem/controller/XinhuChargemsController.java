 ...
 */
@RestController
@RequestMapping("/system/chargems")
public class XinhuChargemsController extends BaseController
{
     ...
     * 查询系统升级列表
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:list')")
    @GetMapping("/list")
     ...
     * 导出系统升级列表
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:export')")
     ...
     * 获取系统升级详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增系统升级
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:add')")
     ...
     * 修改系统升级
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:edit')")
     ...
     * 删除系统升级
     */
    @PreAuthorize("@ss.hasPermi('system:chargems:remove')")
