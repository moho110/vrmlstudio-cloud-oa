...
public class XinhuLogintokenController extends BaseController
{
     ...
     * 查询系统登录token列表
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:list')")
    @GetMapping("/list")
     ...
     * 导出系统登录token列表
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:export')")
     ...
     * 获取系统登录token详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增系统登录token
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:add')")
     ...
     * 修改系统登录token
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:edit')")
     ...
     * 删除系统登录token
     */
    @PreAuthorize("@ss.hasPermi('system:logintoken:remove')")
