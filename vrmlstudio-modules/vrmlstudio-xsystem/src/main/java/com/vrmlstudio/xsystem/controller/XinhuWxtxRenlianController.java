...
public class XinhuWxtxRenlianController extends BaseController
{
     ...
     * 查询人脸识别列表
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:list')")
    @GetMapping("/list")
     ...
     * 导出人脸识别列表
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:export')")
     ...
     * 获取人脸识别详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增人脸识别
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:add')")
     ...
     * 修改人脸识别
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:edit')")
     ...
     * 删除人脸识别
     */
    @PreAuthorize("@ss.hasPermi('system:renlian:remove')")
