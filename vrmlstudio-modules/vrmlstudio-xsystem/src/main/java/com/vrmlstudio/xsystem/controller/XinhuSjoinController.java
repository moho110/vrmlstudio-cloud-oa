...
public class XinhuSjoinController extends BaseController
{
     ...
     * 查询后台菜单权限列表
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:list')")
    @GetMapping("/list")
     ...
     * 导出后台菜单权限列表
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:export')")
     ...
     * 获取后台菜单权限详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增后台菜单权限
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:add')")
     ...
     * 修改后台菜单权限
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:edit')")
     ...
     * 删除后台菜单权限
     */
    @PreAuthorize("@ss.hasPermi('system:sjoin:remove')")
