...
public class XinhuWotplController extends BaseController
{
     ...
     * 查询微信公众号消息模版列表
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:list')")
    @GetMapping("/list")
     ...
     * 导出微信公众号消息模版列表
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:export')")
     ...
     * 获取微信公众号消息模版详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增微信公众号消息模版
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:add')")
     ...
     * 修改微信公众号消息模版
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:edit')")
     ...
     * 删除微信公众号消息模版
     */
    @PreAuthorize("@ss.hasPermi('system:wotpl:remove')")
