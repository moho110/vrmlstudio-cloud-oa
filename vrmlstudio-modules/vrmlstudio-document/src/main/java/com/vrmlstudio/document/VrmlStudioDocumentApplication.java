package com.vrmlstudio.document;
...
public class VrmlStudioDocumentApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(VrmlStudioDocumentApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  公文处理模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
