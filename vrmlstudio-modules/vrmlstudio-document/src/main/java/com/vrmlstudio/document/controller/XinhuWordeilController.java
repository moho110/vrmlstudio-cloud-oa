...
public class XinhuWordeilController extends BaseController
{
     ...
     * 查询文件传送列表
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:list')")
    @GetMapping("/list")
     ...
     * 导出文件传送列表
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:export')")
     ...
     * 获取文件传送详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文件传送
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:add')")
     ...
     * 修改文件传送
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:edit')")
     ...
     * 删除文件传送
     */
    @PreAuthorize("@ss.hasPermi('document:wordeil:remove')")
