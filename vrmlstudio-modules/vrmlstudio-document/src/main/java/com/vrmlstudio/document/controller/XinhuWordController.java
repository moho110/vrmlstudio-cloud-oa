...
public class XinhuWordController extends BaseController
{
     ...
     * 查询文档列表
     */
    @PreAuthorize("@ss.hasPermi('document:word:list')")
    @GetMapping("/list")
     ...
     * 导出文档列表
     */
    @PreAuthorize("@ss.hasPermi('document:word:export')")
     ...
     * 获取文档详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:word:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文档
     */
    @PreAuthorize("@ss.hasPermi('document:word:add')")
     ...
     * 修改文档
     */
    @PreAuthorize("@ss.hasPermi('document:word:edit')")
     ...
     * 删除文档
     */
    @PreAuthorize("@ss.hasPermi('document:word:remove')")
