...
public class XinhuSealaplController extends BaseController
{
     ...
     * 查询印章申请使用列表
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:list')")
    @GetMapping("/list")
     ...
     * 导出印章申请使用列表
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:export')")
     ...
     * 获取印章申请使用详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增印章申请使用
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:add')")
     ...
     * 修改印章申请使用
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:edit')")
     ...
     * 删除印章申请使用
     */
    @PreAuthorize("@ss.hasPermi('document:sealapl:remove')")
