...
public class XinhuWenjuanController extends BaseController
{
     ...
     * 查询问卷列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:list')")
    @GetMapping("/list")
     ...
     * 导出问卷列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:export')")
     ...
     * 获取问卷详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增问卷
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:add')")
     ...
     * 修改问卷
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:edit')")
     ...
     * 删除问卷
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuan:remove')")
