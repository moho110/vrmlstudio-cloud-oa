...
public class XinhuWorcController extends BaseController
{
     ...
     * 查询文档分区列表
     */
    @PreAuthorize("@ss.hasPermi('document:worc:list')")
    @GetMapping("/list")
     ...
     * 导出文档分区列表
     */
    @PreAuthorize("@ss.hasPermi('document:worc:export')")
     ...
     * 获取文档分区详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:worc:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文档分区
     */
    @PreAuthorize("@ss.hasPermi('document:worc:add')")
     ...
     * 修改文档分区
     */
    @PreAuthorize("@ss.hasPermi('document:worc:edit')")
     ...
     * 删除文档分区
     */
    @PreAuthorize("@ss.hasPermi('document:worc:remove')")
