...
public class XinhuWordxieController extends BaseController
{
     ...
     * 查询文档协作列表
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:list')")
    @GetMapping("/list")
     ...
     * 导出文档协作列表
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:export')")
     ...
     * 获取文档协作详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文档协作
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:add')")
     ...
     * 修改文档协作
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:edit')")
     ...
     * 删除文档协作
     */
    @PreAuthorize("@ss.hasPermi('document:wordxie:remove')")
