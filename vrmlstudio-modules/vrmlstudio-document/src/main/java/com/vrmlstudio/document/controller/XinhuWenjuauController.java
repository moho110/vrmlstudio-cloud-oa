...
public class XinhuWenjuauController extends BaseController
{
     ...
     * 查询问卷子列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:list')")
    @GetMapping("/list")
     ...
     * 导出问卷子列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:export')")
     ...
     * 获取问卷子详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:add')")
     ...
     * 修改问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:edit')")
     ...
     * 删除问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuau:remove')")
