...
public class XinhuWenjuatController extends BaseController
{
     ...
     * 查询问卷子列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:list')")
    @GetMapping("/list")
     ...
     * 导出问卷子列表
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:export')")
     ...
     * 获取问卷子详细信息
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:add')")
     ...
     * 修改问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:edit')")
     ...
     * 删除问卷子
     */
    @PreAuthorize("@ss.hasPermi('document:wenjuat:remove')")
