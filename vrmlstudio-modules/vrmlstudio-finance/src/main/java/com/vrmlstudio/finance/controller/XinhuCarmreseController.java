...
public class XinhuCarmreseController extends BaseController
{
     ...
     * 查询车辆预定列表
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:list')")
    @GetMapping("/list")
     ...
     * 导出车辆预定列表
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:export')")
     ...
     * 获取车辆预定详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增车辆预定
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:add')")
     ...
     * 修改车辆预定
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:edit')")
     ...
     * 删除车辆预定
     */
    @PreAuthorize("@ss.hasPermi('finance:carmrese:remove')")
