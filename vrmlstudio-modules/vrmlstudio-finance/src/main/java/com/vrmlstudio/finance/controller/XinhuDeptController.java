...
public class XinhuDeptController extends BaseController
{
     ...
     * 查询组织结构部门列表
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:list')")
    @GetMapping("/list")
     ...
     * 导出组织结构部门列表
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:export')")
     ...
     * 获取组织结构部门详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增组织结构部门
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:add')")
     ...
     * 修改组织结构部门
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:edit')")
     ...
     * 删除组织结构部门
     */
    @PreAuthorize("@ss.hasPermi('finance:dept:remove')")
