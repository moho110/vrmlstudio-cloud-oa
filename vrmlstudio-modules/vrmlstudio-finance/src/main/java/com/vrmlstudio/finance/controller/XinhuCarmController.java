...
public class XinhuCarmController extends BaseController
{
     ...
     * 查询车辆列表
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:list')")
    @GetMapping("/list")
     ...
     * 导出车辆列表
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:export')")
     ...
     * 获取车辆详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增车辆
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:add')")
     ...
     * 修改车辆
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:edit')")
     ...
     * 删除车辆
     */
    @PreAuthorize("@ss.hasPermi('finance:carm:remove')")
