...
public class XinhuCustfinaController extends BaseController
{
     ...
     * 查询客户收付款列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:list')")
    @GetMapping("/list")
     ...
     * 导出客户收付款列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:export')")
     ...
     * 获取客户收付款详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增客户收付款
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:add')")
     ...
     * 修改客户收付款
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:edit')")
     ...
     * 删除客户收付款
     */
    @PreAuthorize("@ss.hasPermi('finance:custfina:remove')")
