...
public class XinhuCustappyController extends BaseController
{
     ...
     * 查询客户申请使用列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:list')")
    @GetMapping("/list")
     ...
     * 导出客户申请使用列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:export')")
     ...
     * 获取客户申请使用详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增客户申请使用
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:add')")
     ...
     * 修改客户申请使用
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:edit')")
     ...
     * 删除客户申请使用
     */
    @PreAuthorize("@ss.hasPermi('finance:custappy:remove')")
