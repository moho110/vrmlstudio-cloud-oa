...
public class XinhuCustractController extends BaseController
{
     ...
     * 查询客户合同列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:list')")
    @GetMapping("/list")
     ...
     * 导出客户合同列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:export')")
     ...
     * 获取客户合同详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增客户合同
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:add')")
     ...
     * 修改客户合同
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:edit')")
     ...
     * 删除客户合同
     */
    @PreAuthorize("@ss.hasPermi('finance:custract:remove')")
