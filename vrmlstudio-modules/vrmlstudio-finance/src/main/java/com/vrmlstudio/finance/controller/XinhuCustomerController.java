...
public class XinhuCustomerController extends BaseController
{
     ...
     * 查询客户列表
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:list')")
    @GetMapping("/list")
     ...
     * 导出客户列表
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:export')")
     ...
     * 获取客户详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增客户
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:add')")
     ...
     * 修改客户
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:edit')")
     ...
     * 删除客户
     */
    @PreAuthorize("@ss.hasPermi('finance:customer:remove')")
