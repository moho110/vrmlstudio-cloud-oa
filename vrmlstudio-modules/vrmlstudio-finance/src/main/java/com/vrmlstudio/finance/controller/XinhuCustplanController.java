...
public class XinhuCustplanController extends BaseController
{
     ...
     * 查询跟进计划列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:list')")
    @GetMapping("/list")
     ...
     * 导出跟进计划列表
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:export')")
     ...
     * 获取跟进计划详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增跟进计划
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:add')")
     ...
     * 修改跟进计划
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:edit')")
     ...
     * 删除跟进计划
     */
    @PreAuthorize("@ss.hasPermi('finance:custplan:remove')")
