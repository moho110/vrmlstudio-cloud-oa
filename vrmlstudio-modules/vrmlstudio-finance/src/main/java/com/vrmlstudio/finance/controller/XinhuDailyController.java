...
public class XinhuDailyController extends BaseController
{
     ...
     * 查询日报列表
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:list')")
    @GetMapping("/list")
     ...
     * 导出日报列表
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:export')")
     ...
     * 获取日报详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增日报
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:add')")
     ...
     * 修改日报
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:edit')")
     ...
     * 删除日报
     */
    @PreAuthorize("@ss.hasPermi('finance:daily:remove')")
