...
public class XinhuDemoController extends BaseController
{
     ...
     * 查询演示测试模块列表
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:list')")
    @GetMapping("/list")
     ...
     * 导出演示测试模块列表
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:export')")
     ...
     * 获取演示测试模块详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增演示测试模块
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:add')")
     ...
     * 修改演示测试模块
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:edit')")
     ...
     * 删除演示测试模块
     */
    @PreAuthorize("@ss.hasPermi('finance:demo:remove')")
