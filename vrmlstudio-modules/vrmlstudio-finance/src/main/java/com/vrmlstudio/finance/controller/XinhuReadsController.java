...
public class XinhuReadsController extends BaseController
{
     ...
     * 查询单据浏览记录列表
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:list')")
    @GetMapping("/list")
     ...
     * 导出单据浏览记录列表
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:export')")
     ...
     * 获取单据浏览记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据浏览记录
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:add')")
     ...
     * 修改单据浏览记录
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:edit')")
     ...
     * 删除单据浏览记录
     */
    @PreAuthorize("@ss.hasPermi('finance:reads:remove')")
