...
public class XinhuTovoidController extends BaseController
{
     ...
     * 查询单据申请作废列表
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:list')")
    @GetMapping("/list")
     ...
     * 导出单据申请作废列表
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:export')")
     ...
     * 获取单据申请作废详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据申请作废
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:add')")
     ...
     * 修改单据申请作废
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:edit')")
     ...
     * 删除单据申请作废
     */
    @PreAuthorize("@ss.hasPermi('finance:tovoid:remove')")
