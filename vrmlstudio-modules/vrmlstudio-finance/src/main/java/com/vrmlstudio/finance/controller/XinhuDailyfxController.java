...
public class XinhuDailyfxController extends BaseController
{
     ...
     * 查询日报分析统计列表
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:list')")
    @GetMapping("/list")
     ...
     * 导出日报分析统计列表
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:export')")
     ...
     * 获取日报分析统计详细信息
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增日报分析统计
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:add')")
     ...
     * 修改日报分析统计
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:edit')")
     ...
     * 删除日报分析统计
     */
    @PreAuthorize("@ss.hasPermi('finance:dailyfx:remove')")
