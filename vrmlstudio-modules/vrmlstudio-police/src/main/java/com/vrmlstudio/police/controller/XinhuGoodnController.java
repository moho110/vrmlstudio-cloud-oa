...
public class XinhuGoodnController extends BaseController
{
     ...
     * 查询物品库存详细列表
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:list')")
    @GetMapping("/list")
     ...
     * 导出物品库存详细列表
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:export')")
     ...
     * 获取物品库存详细详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增物品库存详细
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:add')")
     ...
     * 修改物品库存详细
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:edit')")
     ...
     * 删除物品库存详细
     */
    @PreAuthorize("@ss.hasPermi('police:goodn:remove')")
