...
public class XinhuGodepotController extends BaseController
{
     ...
     * 查询物品仓库列表
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:list')")
    @GetMapping("/list")
     ...
     * 导出物品仓库列表
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:export')")
     ...
     * 获取物品仓库详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增物品仓库
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:add')")
     ...
     * 修改物品仓库
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:edit')")
     ...
     * 删除物品仓库
     */
    @PreAuthorize("@ss.hasPermi('police:godepot:remove')")
