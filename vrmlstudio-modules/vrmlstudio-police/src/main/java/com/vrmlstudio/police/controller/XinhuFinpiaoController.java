...
public class XinhuFinpiaoController extends BaseController
{
     ...
     * 查询发票管理列表
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:list')")
    @GetMapping("/list")
     ...
     * 导出发票管理列表
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:export')")
     ...
     * 获取发票管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增发票管理
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:add')")
     ...
     * 修改发票管理
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:edit')")
     ...
     * 删除发票管理
     */
    @PreAuthorize("@ss.hasPermi('police:finpiao:remove')")
