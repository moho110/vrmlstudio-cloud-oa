...
public class XinhuGctodoController extends BaseController
{
     ...
     * 查询工程通知列表
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:list')")
    @GetMapping("/list")
     ...
     * 导出工程通知列表
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:export')")
     ...
     * 获取工程通知详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增工程通知
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:add')")
     ...
     * 修改工程通知
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:edit')")
     ...
     * 删除工程通知
     */
    @PreAuthorize("@ss.hasPermi('police:gctodo:remove')")
