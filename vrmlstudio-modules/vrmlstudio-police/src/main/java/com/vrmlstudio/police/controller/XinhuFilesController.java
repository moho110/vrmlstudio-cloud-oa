...
public class XinhuFilesController extends BaseController
{
     ...
     * 查询文件记录下载和预览列表
     */
    @PreAuthorize("@ss.hasPermi('police:files:list')")
    @GetMapping("/list")
     ...
     * 导出文件记录下载和预览列表
     */
    @PreAuthorize("@ss.hasPermi('police:files:export')")
     ...
     * 获取文件记录下载和预览详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:files:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文件记录下载和预览
     */
    @PreAuthorize("@ss.hasPermi('police:files:add')")
     ...
     * 修改文件记录下载和预览
     */
    @PreAuthorize("@ss.hasPermi('police:files:edit')")
     ...
     * 删除文件记录下载和预览
     */
    @PreAuthorize("@ss.hasPermi('police:files:remove')")
