...
public class VrmlStudioPoliceApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(VrmlStudioPoliceApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  行政管理模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
