...
public class XinhuFileController extends BaseController
{
     ...
     * 查询上传文件记录列表
     */
    @PreAuthorize("@ss.hasPermi('police:file:list')")
    @GetMapping("/list")
     ...
     * 导出上传文件记录列表
     */
    @PreAuthorize("@ss.hasPermi('police:file:export')")
     ...
     * 获取上传文件记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:file:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增上传文件记录
     */
    @PreAuthorize("@ss.hasPermi('police:file:add')")
     ...
     * 修改上传文件记录
     */
    @PreAuthorize("@ss.hasPermi('police:file:edit')")
     ...
     * 删除上传文件记录
     */
    @PreAuthorize("@ss.hasPermi('police:file:remove')")
