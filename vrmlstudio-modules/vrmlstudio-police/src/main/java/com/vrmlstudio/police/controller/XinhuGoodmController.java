...
public class XinhuGoodmController extends BaseController
{
     ...
     * 查询物品领用采购申请主列表
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:list')")
    @GetMapping("/list")
     ...
     * 导出物品领用采购申请主列表
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:export')")
     ...
     * 获取物品领用采购申请主详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增物品领用采购申请主
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:add')")
     ...
     * 修改物品领用采购申请主
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:edit')")
     ...
     * 删除物品领用采购申请主
     */
    @PreAuthorize("@ss.hasPermi('police:goodm:remove')")
