...
public class XinhuGoodsController extends BaseController
{
     ...
     * 查询物品列表
     */
    @PreAuthorize("@ss.hasPermi('police:goods:list')")
    @GetMapping("/list")
     ...
     * 导出物品列表
     */
    @PreAuthorize("@ss.hasPermi('police:goods:export')")
     ...
     * 获取物品详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:goods:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增物品
     */
    @PreAuthorize("@ss.hasPermi('police:goods:add')")
     ...
     * 修改物品
     */
    @PreAuthorize("@ss.hasPermi('police:goods:edit')")
     ...
     * 删除物品
     */
    @PreAuthorize("@ss.hasPermi('police:goods:remove')")
