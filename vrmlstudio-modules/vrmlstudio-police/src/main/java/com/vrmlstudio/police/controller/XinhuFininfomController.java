...
public class XinhuFininfomController extends BaseController
{
     ...
     * 查询费用报销列表
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:list')")
    @GetMapping("/list")
     ...
     * 导出费用报销列表
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:export')")
     ...
     * 获取费用报销详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增费用报销
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:add')")
     ...
     * 修改费用报销
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:edit')")
     ...
     * 删除费用报销
     */
    @PreAuthorize("@ss.hasPermi('police:fininfom:remove')")
