...
public class XinhuEmailmController extends BaseController
{
     ...
     * 查询邮件主列表
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:list')")
    @GetMapping("/list")
     ...
     * 导出邮件主列表
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:export')")
     ...
     * 获取邮件主详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增邮件主
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:add')")
     ...
     * 修改邮件主
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:edit')")
     ...
     * 删除邮件主
     */
    @PreAuthorize("@ss.hasPermi('police:emailm:remove')")
