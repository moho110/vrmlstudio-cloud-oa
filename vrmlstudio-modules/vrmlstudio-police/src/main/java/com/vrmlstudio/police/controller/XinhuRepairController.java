...
public class XinhuRepairController extends BaseController
{
     ...
     * 查询维修报修列表
     */
    @PreAuthorize("@ss.hasPermi('police:repair:list')")
    @GetMapping("/list")
     ...
     * 导出维修报修列表
     */
    @PreAuthorize("@ss.hasPermi('police:repair:export')")
     ...
     * 获取维修报修详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:repair:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增维修报修
     */
    @PreAuthorize("@ss.hasPermi('police:repair:add')")
     ...
     * 修改维修报修
     */
    @PreAuthorize("@ss.hasPermi('police:repair:edit')")
     ...
     * 删除维修报修
     */
    @PreAuthorize("@ss.hasPermi('police:repair:remove')")
