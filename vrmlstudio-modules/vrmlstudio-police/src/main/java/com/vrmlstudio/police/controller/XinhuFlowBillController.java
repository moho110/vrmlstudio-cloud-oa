...
public class XinhuFlowBillController extends BaseController
{
     ...
     * 查询流程单据列表
     */
    @PreAuthorize("@ss.hasPermi('police:bill:list')")
    @GetMapping("/list")
     ...
     * 导出流程单据列表
     */
    @PreAuthorize("@ss.hasPermi('police:bill:export')")
     ...
     * 获取流程单据详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:bill:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增流程单据
     */
    @PreAuthorize("@ss.hasPermi('police:bill:add')")
     ...
     * 修改流程单据
     */
    @PreAuthorize("@ss.hasPermi('police:bill:edit')")
     ...
     * 删除流程单据
     */
    @PreAuthorize("@ss.hasPermi('police:bill:remove')")
