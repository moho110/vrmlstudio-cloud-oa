...
public class XinhuEmailContController extends BaseController
{
     ...
     * 查询系统发送邮件内容列表
     */
    @PreAuthorize("@ss.hasPermi('police:cont:list')")
    @GetMapping("/list")
     ...
     * 导出系统发送邮件内容列表
     */
    @PreAuthorize("@ss.hasPermi('police:cont:export')")
     ...
     * 获取系统发送邮件内容详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:cont:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增系统发送邮件内容
     */
    @PreAuthorize("@ss.hasPermi('police:cont:add')")
     ...
     * 修改系统发送邮件内容
     */
    @PreAuthorize("@ss.hasPermi('police:cont:edit')")
     ...
     * 删除系统发送邮件内容
     */
    @PreAuthorize("@ss.hasPermi('police:cont:remove')")
