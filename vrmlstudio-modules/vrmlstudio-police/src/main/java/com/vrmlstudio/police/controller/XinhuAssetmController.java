...
public class XinhuAssetmController extends BaseController
{
     ...
     * 查询固定资产列表
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:list')")
    @GetMapping("/list")
     ...
     * 导出固定资产列表
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:export')")
     ...
     * 获取固定资产详细信息
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增固定资产
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:add')")
     ...
     * 修改固定资产
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:edit')")
     ...
     * 删除固定资产
     */
    @PreAuthorize("@ss.hasPermi('police:assetm:remove')")
