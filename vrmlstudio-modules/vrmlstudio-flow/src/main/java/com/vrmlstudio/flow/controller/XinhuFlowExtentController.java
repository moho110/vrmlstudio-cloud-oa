...
public class XinhuFlowExtentController extends BaseController
{
     ...
     * 查询模块权限列表
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:list')")
    @GetMapping("/list")
     ...
     * 导出模块权限列表
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:export')")
     ...
     * 获取模块权限详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增模块权限
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:add')")
     ...
     * 修改模块权限
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:edit')")
     ...
     * 删除模块权限
     */
    @PreAuthorize("@ss.hasPermi('flow:extent:remove')")
