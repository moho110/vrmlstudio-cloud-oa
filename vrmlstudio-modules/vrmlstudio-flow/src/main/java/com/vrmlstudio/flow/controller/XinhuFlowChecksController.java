...
public class XinhuFlowChecksController extends BaseController
{
     ...
     * 查询单据的审核人列表
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:list')")
    @GetMapping("/list")
     ...
     * 导出单据的审核人列表
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:export')")
     ...
     * 获取单据的审核人详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据的审核人
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:add')")
     ...
     * 修改单据的审核人
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:edit')")
     ...
     * 删除单据的审核人
     */
    @PreAuthorize("@ss.hasPermi('flow:checks:remove')")
