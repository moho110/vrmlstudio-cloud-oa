...
public class XinhuFlowTodoController extends BaseController
{
     ...
     * 查询单据通知设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:list')")
    @GetMapping("/list")
     ...
     * 导出单据通知设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:export')")
     ...
     * 获取单据通知设置详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据通知设置
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:add')")
     ...
     * 修改单据通知设置
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:edit')")
     ...
     * 删除单据通知设置
     */
    @PreAuthorize("@ss.hasPermi('flow:todo:remove')")
