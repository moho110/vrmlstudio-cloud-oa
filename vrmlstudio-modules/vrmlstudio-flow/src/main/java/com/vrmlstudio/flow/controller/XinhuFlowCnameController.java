...
public class XinhuFlowCnameController extends BaseController
{
     ...
     * 查询自定义审核人组列表
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:list')")
    @GetMapping("/list")
     ...
     * 导出自定义审核人组列表
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:export')")
     ...
     * 获取自定义审核人组详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增自定义审核人组
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:add')")
     ...
     * 修改自定义审核人组
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:edit')")
     ...
     * 删除自定义审核人组
     */
    @PreAuthorize("@ss.hasPermi('flow:cname:remove')")
