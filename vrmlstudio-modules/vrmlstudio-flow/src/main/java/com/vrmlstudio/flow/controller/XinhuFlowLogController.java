...
public class XinhuFlowLogController extends BaseController
{
     ...
     * 查询单据操作记录列表
     */
    @PreAuthorize("@ss.hasPermi('flow:log:list')")
    @GetMapping("/list")
     ...
     * 导出单据操作记录列表
     */
    @PreAuthorize("@ss.hasPermi('flow:log:export')")
     ...
     * 获取单据操作记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:log:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据操作记录
     */
    @PreAuthorize("@ss.hasPermi('flow:log:add')")
     ...
     * 修改单据操作记录
     */
    @PreAuthorize("@ss.hasPermi('flow:log:edit')")
     ...
     * 删除单据操作记录
     */
    @PreAuthorize("@ss.hasPermi('flow:log:remove')")
