...
public class XinhuFlowRemindController extends BaseController
{
     ...
     * 查询单据提醒设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:list')")
    @GetMapping("/list")
     ...
     * 导出单据提醒设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:export')")
     ...
     * 获取单据提醒设置详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据提醒设置
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:add')")
     ...
     * 修改单据提醒设置
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:edit')")
     ...
     * 删除单据提醒设置
     */
    @PreAuthorize("@ss.hasPermi('flow:remind:remove')")
