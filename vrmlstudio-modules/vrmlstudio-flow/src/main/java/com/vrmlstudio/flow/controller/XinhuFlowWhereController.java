...
public class XinhuFlowWhereController extends BaseController
{
     ...
     * 查询单据条件列表
     */
    @PreAuthorize("@ss.hasPermi('flow:where:list')")
    @GetMapping("/list")
     ...
     * 导出单据条件列表
     */
    @PreAuthorize("@ss.hasPermi('flow:where:export')")
     ...
     * 获取单据条件详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:where:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据条件
     */
    @PreAuthorize("@ss.hasPermi('flow:where:add')")
     ...
     * 修改单据条件
     */
    @PreAuthorize("@ss.hasPermi('flow:where:edit')")
     ...
     * 删除单据条件
     */
    @PreAuthorize("@ss.hasPermi('flow:where:remove')")
