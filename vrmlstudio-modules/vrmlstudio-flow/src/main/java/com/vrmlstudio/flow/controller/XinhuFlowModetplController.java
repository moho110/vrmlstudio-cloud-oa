...
public class XinhuFlowModetplController extends BaseController
{
     ...
     * 查询模块多模版设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:list')")
    @GetMapping("/list")
     ...
     * 导出模块多模版设置列表
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:export')")
     ...
     * 获取模块多模版设置详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增模块多模版设置
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:add')")
     ...
     * 修改模块多模版设置
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:edit')")
     ...
     * 删除模块多模版设置
     */
    @PreAuthorize("@ss.hasPermi('flow:modetpl:remove')")
