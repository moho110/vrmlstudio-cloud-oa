...
public class XinhuFlowTodosController extends BaseController
{
     ...
     * 查询单据通知给对应人员列表
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:list')")
    @GetMapping("/list")
     ...
     * 导出单据通知给对应人员列表
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:export')")
     ...
     * 获取单据通知给对应人员详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增单据通知给对应人员
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:add')")
     ...
     * 修改单据通知给对应人员
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:edit')")
     ...
     * 删除单据通知给对应人员
     */
    @PreAuthorize("@ss.hasPermi('flow:todos:remove')")
