...
public class XinhuFlowSetController extends BaseController
{
     ...
     * 查询流程模块列表
     */
    @PreAuthorize("@ss.hasPermi('flow:set:list')")
    @GetMapping("/list")
     ...
     * 导出流程模块列表
     */
    @PreAuthorize("@ss.hasPermi('flow:set:export')")
     ...
     * 获取流程模块详细信息
     */
    @PreAuthorize("@ss.hasPermi('flow:set:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增流程模块
     */
    @PreAuthorize("@ss.hasPermi('flow:set:add')")
     ...
     * 修改流程模块
     */
    @PreAuthorize("@ss.hasPermi('flow:set:edit')")
     ...
     * 删除流程模块
     */
    @PreAuthorize("@ss.hasPermi('flow:set:remove')")
