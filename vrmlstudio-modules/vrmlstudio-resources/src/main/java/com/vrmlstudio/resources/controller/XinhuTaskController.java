...
public class XinhuTaskController extends BaseController
{
     ...
     * 查询计划任务列表
     */
    @PreAuthorize("@ss.hasPermi('resources:task:list')")
    @GetMapping("/list")
     ...
     * 导出计划任务列表
     */
    @PreAuthorize("@ss.hasPermi('resources:task:export')")
     ...
     * 获取计划任务详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:task:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增计划任务
     */
    @PreAuthorize("@ss.hasPermi('resources:task:add')")
     ...
     * 修改计划任务
     */
    @PreAuthorize("@ss.hasPermi('resources:task:edit')")
     ...
     * 删除计划任务
     */
    @PreAuthorize("@ss.hasPermi('resources:task:remove')")
