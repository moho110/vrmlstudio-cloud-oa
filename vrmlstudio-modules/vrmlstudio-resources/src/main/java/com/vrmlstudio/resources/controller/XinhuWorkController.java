...
public class XinhuWorkController extends BaseController
{
     ...
     * 查询任务列表
     */
    @PreAuthorize("@ss.hasPermi('resources:work:list')")
    @GetMapping("/list")
     ...
     * 导出任务列表
     */
    @PreAuthorize("@ss.hasPermi('resources:work:export')")
     ...
     * 获取任务详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:work:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增任务
     */
    @PreAuthorize("@ss.hasPermi('resources:work:add')")
     ...
     * 修改任务
     */
    @PreAuthorize("@ss.hasPermi('resources:work:edit')")
     ...
     * 删除任务
     */
    @PreAuthorize("@ss.hasPermi('resources:work:remove')")
