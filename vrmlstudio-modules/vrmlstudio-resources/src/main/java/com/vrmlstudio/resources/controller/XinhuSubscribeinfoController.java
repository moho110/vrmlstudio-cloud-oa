...
public class XinhuSubscribeinfoController extends BaseController
{
     ...
     * 查询订阅内容信息列表
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:list')")
    @GetMapping("/list")
     ...
     * 导出订阅内容信息列表
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:export')")
     ...
     * 获取订阅内容信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增订阅内容信息
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:add')")
     ...
     * 修改订阅内容信息
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:edit')")
     ...
     * 删除订阅内容信息
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribeinfo:remove')")
