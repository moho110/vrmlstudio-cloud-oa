...
public class XinhuProjectController extends BaseController
{
     ...
     * 查询项目列表
     */
    @PreAuthorize("@ss.hasPermi('resources:project:list')")
    @GetMapping("/list")
     ...
     * 导出项目列表
     */
    @PreAuthorize("@ss.hasPermi('resources:project:export')")
     ...
     * 获取项目详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:project:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增项目
     */
    @PreAuthorize("@ss.hasPermi('resources:project:add')")
     ...
     * 修改项目
     */
    @PreAuthorize("@ss.hasPermi('resources:project:edit')")
     ...
     * 删除项目
     */
    @PreAuthorize("@ss.hasPermi('resources:project:remove')")
