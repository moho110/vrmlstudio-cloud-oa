...
public class XinhuScheduleController extends BaseController
{
     ...
     * 查询日程列表
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:list')")
    @GetMapping("/list")
     ...
     * 导出日程列表
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:export')")
     ...
     * 获取日程详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增日程
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:add')")
     ...
     * 修改日程
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:edit')")
     ...
     * 删除日程
     */
    @PreAuthorize("@ss.hasPermi('resources:schedule:remove')")
