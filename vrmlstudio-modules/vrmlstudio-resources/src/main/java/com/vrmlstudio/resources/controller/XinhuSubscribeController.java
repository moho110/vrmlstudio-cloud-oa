...
public class XinhuSubscribeController extends BaseController
{
     ...
     * 查询订阅管理列表
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:list')")
    @GetMapping("/list")
     ...
     * 导出订阅管理列表
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:export')")
     ...
     * 获取订阅管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增订阅管理
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:add')")
     ...
     * 修改订阅管理
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:edit')")
     ...
     * 删除订阅管理
     */
    @PreAuthorize("@ss.hasPermi('resources:subscribe:remove')")
