...
public class XinhuUserractController extends BaseController
{
     ...
     * 查询用户合同列表
     */
    @PreAuthorize("@ss.hasPermi('person:userract:list')")
    @GetMapping("/list")
     ...
     * 导出用户合同列表
     */
    @PreAuthorize("@ss.hasPermi('person:userract:export')")
     ...
     * 获取用户合同详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:userract:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户合同
     */
    @PreAuthorize("@ss.hasPermi('person:userract:add')")
     ...
     * 修改用户合同
     */
    @PreAuthorize("@ss.hasPermi('person:userract:edit')")
     ...
     * 删除用户合同
     */
    @PreAuthorize("@ss.hasPermi('person:userract:remove')")
