...
public class XinhuCompanyController extends BaseController
{
     ...
     * 查询公司单位列表
     */
    @PreAuthorize("@ss.hasPermi('person:company:list')")
    @GetMapping("/list")
     ...
     * 导出公司单位列表
     */
    @PreAuthorize("@ss.hasPermi('person:company:export')")
     ...
     * 获取公司单位详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:company:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增公司单位
     */
    @PreAuthorize("@ss.hasPermi('person:company:add')")
     ...
     * 修改公司单位
     */
    @PreAuthorize("@ss.hasPermi('person:company:edit')")
     ...
     * 删除公司单位
     */
    @PreAuthorize("@ss.hasPermi('person:company:remove')")
