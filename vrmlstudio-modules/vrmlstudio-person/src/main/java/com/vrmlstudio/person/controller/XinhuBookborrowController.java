...
public class XinhuBookborrowController extends BaseController
{
     ...
     * 查询图书借阅列表
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:list')")
    @GetMapping("/list")
     ...
     * 导出图书借阅列表
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:export')")
     ...
     * 获取图书借阅详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增图书借阅
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:add')")
     ...
     * 修改图书借阅
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:edit')")
     ...
     * 删除图书借阅
     */
    @PreAuthorize("@ss.hasPermi('person:bookborrow:remove')")
