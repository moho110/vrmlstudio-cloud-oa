...
public class XinhuUserinfoController extends BaseController
{
     ...
     * 查询用户档案列表
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:list')")
    @GetMapping("/list")
     ...
     * 导出用户档案列表
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:export')")
     ...
     * 获取用户档案详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户档案
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:add')")
     ...
     * 修改用户档案
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:edit')")
     ...
     * 删除用户档案
     */
    @PreAuthorize("@ss.hasPermi('person:userinfo:remove')")
