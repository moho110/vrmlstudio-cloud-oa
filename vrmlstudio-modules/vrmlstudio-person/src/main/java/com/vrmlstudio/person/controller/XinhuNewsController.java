...
public class XinhuNewsController extends BaseController
{
     ...
     * 查询新闻资讯列表
     */
    @PreAuthorize("@ss.hasPermi('person:news:list')")
    @GetMapping("/list")
     ...
     * 导出新闻资讯列表
     */
    @PreAuthorize("@ss.hasPermi('person:news:export')")
     ...
     * 获取新闻资讯详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:news:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增新闻资讯
     */
    @PreAuthorize("@ss.hasPermi('person:news:add')")
     ...
     * 修改新闻资讯
     */
    @PreAuthorize("@ss.hasPermi('person:news:edit')")
     ...
     * 删除新闻资讯
     */
    @PreAuthorize("@ss.hasPermi('person:news:remove')")
