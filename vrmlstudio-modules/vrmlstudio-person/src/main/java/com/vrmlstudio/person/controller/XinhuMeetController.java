...
public class XinhuMeetController extends BaseController
{
     ...
     * 查询会议列表
     */
    @PreAuthorize("@ss.hasPermi('person:meet:list')")
    @GetMapping("/list")
     ...
     * 导出会议列表
     */
    @PreAuthorize("@ss.hasPermi('person:meet:export')")
     ...
     * 获取会议详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:meet:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增会议
     */
    @PreAuthorize("@ss.hasPermi('person:meet:add')")
     ...
     * 修改会议
     */
    @PreAuthorize("@ss.hasPermi('person:meet:edit')")
     ...
     * 删除会议
     */
    @PreAuthorize("@ss.hasPermi('person:meet:remove')")
