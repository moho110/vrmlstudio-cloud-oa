...
public class XinhuUserinfosController extends BaseController
{
     ...
     * 查询人员档案子列表
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:list')")
    @GetMapping("/list")
     ...
     * 导出人员档案子列表
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:export')")
     ...
     * 获取人员档案子详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增人员档案子
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:add')")
     ...
     * 修改人员档案子
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:edit')")
     ...
     * 删除人员档案子
     */
    @PreAuthorize("@ss.hasPermi('person:userinfos:remove')")
