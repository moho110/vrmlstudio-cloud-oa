...
public class XinhuMenuController extends BaseController
{
     ...
     * 查询系统菜单列表
     */
    @PreAuthorize("@ss.hasPermi('person:menu:list')")
    @GetMapping("/list")
     ...
     * 导出系统菜单列表
     */
    @PreAuthorize("@ss.hasPermi('person:menu:export')")
     ...
     * 获取系统菜单详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:menu:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增系统菜单
     */
    @PreAuthorize("@ss.hasPermi('person:menu:add')")
     ...
     * 修改系统菜单
     */
    @PreAuthorize("@ss.hasPermi('person:menu:edit')")
     ...
     * 删除系统菜单
     */
    @PreAuthorize("@ss.hasPermi('person:menu:remove')")
