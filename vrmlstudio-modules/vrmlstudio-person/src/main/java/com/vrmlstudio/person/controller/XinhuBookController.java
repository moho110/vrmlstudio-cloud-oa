...
public class XinhuBookController extends BaseController
{
     ...
     * 查询图书列表
     */
    @PreAuthorize("@ss.hasPermi('person:book:list')")
    @GetMapping("/list")
     ...
     * 导出图书列表
     */
    @PreAuthorize("@ss.hasPermi('person:book:export')")
     ...
     * 获取图书详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:book:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增图书
     */
    @PreAuthorize("@ss.hasPermi('person:book:add')")
     ...
     * 修改图书
     */
    @PreAuthorize("@ss.hasPermi('person:book:edit')")
     ...
     * 删除图书
     */
    @PreAuthorize("@ss.hasPermi('person:book:remove')")
