...
public class XinhuCityController extends BaseController
{
     ...
     * 查询城市列表
     */
    @PreAuthorize("@ss.hasPermi('person:city:list')")
    @GetMapping("/list")
     ...
     * 导出城市列表
     */
    @PreAuthorize("@ss.hasPermi('person:city:export')")
     ...
     * 获取城市详细信息
     */
    @PreAuthorize("@ss.hasPermi('person:city:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增城市
     */
    @PreAuthorize("@ss.hasPermi('person:city:add')")
     ...
     * 修改城市
     */
    @PreAuthorize("@ss.hasPermi('person:city:edit')")
     ...
     * 删除城市
     */
    @PreAuthorize("@ss.hasPermi('person:city:remove')")
